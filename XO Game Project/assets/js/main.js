...
function play(y) {
  ...
  function checkWinner(a, b, c) {
    ...
    if (
      ...
      span[a].perentNode.className += "activebox";
      span[b].perentNode.className += "activebox";
      span[c].perentNode.className += "activebox";
      GameOver(a);
    }
  }
  ...
  function playAgain() {
    document
      ...
      .perentNode.removeChild(document.getElementsByClassName("alert")[0]);
      resetGame();
      window.isGameOver=false;
      for (var k=0; k<span.length; k++) {
        span[k].perentNode.className=span[k].perentNode.className.replace("activebox", "");
      }
  }
